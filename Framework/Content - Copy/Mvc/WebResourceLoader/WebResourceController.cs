...
using OpenData.Web.Mvc.WebResourceLoader.Configuration;
namespace OpenData.Web.Mvc.WebResourceLoader
{
    public class WebResourceController : Controller
    {
        ...
        public void Index(string name, string version, string condition)
        {
            ...
            WebResourcesSection section = ConfigurationManager.GetSection(OpenData.Web.Mvc.AreaHelpers.GetAreaName(this.RouteData));
            if (section == null)
            {
