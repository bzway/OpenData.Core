...
using OpenData.Web.Mvc.Grid2.Design;

namespace OpenData.Web.Mvc.Grid2
{
    public class GridModel : IGridModel
    {
        ...
        public static IGridModel CreateGridModel(Type modelType, IEnumerable dataSource, ViewContext viewContext)
        {
            ...
            {
                throw new InvalidOperationException("Please setup BzwayDataAnnotationsModelMetadataProvider, etc:ModelMetadataProviders.Current = new Bzway.Web.Mvc.BzwayDataAnnotationsModelMetadataProvider()");
            }
