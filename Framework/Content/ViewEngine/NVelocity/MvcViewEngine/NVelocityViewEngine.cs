...
namespace Bzway.Website.Sites.TemplateEngines.NVelocity.MvcViewEngine
{
    public class NVelocityViewEngine : VirtualPathProviderViewEngine, IViewEngine
    {
        ...
        static NVelocityViewEngine()
        {
            ...
            DEFAULT_PROPERTIES.Add("file.resource.loader.class", "Bzway.Website.Sites.TemplateEngines.NVelocity.MvcViewEngine.FileResourceLoaderEx\\,Bzway.Website.Sites.TemplateEngines.NVelocity");
        ...
        public Template GetTemplate(string viewPath)
        {
            ...
            return _engine.GetTemplate(Bzway.Web.Url.UrlUtility.MapPath(viewPath));
        }
