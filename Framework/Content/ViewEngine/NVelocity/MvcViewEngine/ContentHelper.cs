...
using Bzway.Data.Query.Expressions;
...
namespace Bzway.Website.Sites.TemplateEngines.NVelocity.MvcViewEngine
{
        ...
        where T : ContentBase
    {
        ...
        public IContentQuery<T> Create(IExpression expression)
        {
    ...
    public class ContentHelper
    {
        ...
        public static IEnumerable<string> SplitMultiFiles(string files)
        {
            ...
            return files.Split('|').Select(it => Bzway.Web.Url.UrlUtility.ResolveUrl(it)).ToArray();
        }
    }
}
