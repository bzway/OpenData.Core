...
using NVelocity;
using Bzway.Website.Sites.Globalization;
using Bzway.Website.Sites.View;
using Bzway.Data.Models;
using Bzway.Website.Search;
using Bzway.Website.Search.Models;
...
namespace Bzway.Website.Sites.TemplateEngines.NVelocity.MvcViewEngine
{
    ...
    public class NVelocityView : IViewDataContainer, IView
    {
        ...
        private void AddCMSHelpers(Hashtable entries)
        {
            ...
            entries["ServiceFactory"] = new Bzway.Website.Sites.Services.ServiceFactory();
